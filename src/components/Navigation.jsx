    ...
    return (
        ...
        <nav className="navigation">
          <ul className="nav-items">
            <li className="nav-item" onClick={() => { this.props.clickFormClose() }}><Link to="/"><img src="/icon/home.svg" className="nav-item-icon nav-item-home" alt="" /><span className="nav-item-text">ホーム</span></Link></li>
